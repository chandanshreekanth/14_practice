...
public class AmazonSwitchWindow 
{
	...
	public void amazonSwitchWindow() throws InterruptedException
	{
		...
		String childTitle = "Samsung Galaxy S22 5G (Phantom White, 8GB RAM, 128GB Storage) with No Cost EMI/Additional Exchange Offers : Amazon.in: Electronics";
		try 
		{
...
//		}
		...
		String text = driver.findElement(By.xpath("//span[text()=' In stock ']")).getText();
