...
public class Iphone2 {
	...
	public static void main(String[] args) throws Throwable 
	{
		...
		List<WebElement> iphone = driver.findElements(By.xpath("//div[contains(@class, '_30jeq3 _1_WHN1') and number(translate(text(), '₹,', '')) > 10000 and number(translate(text(), '₹,', '')) < 25000]"));
